export default function AIInsightsSkeleton() {
  return (
    <div
      ...
      className="p-6 rounded-xl bg-zinc-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-[rgba(255,255,255,0.08)]"
    >
      {/* Header */}
      ...
      <div className="flex flex-col gap-6">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="flex items-start gap-3 p-3 rounded-lg bg-white dark:bg-[#111] border border-gray-100 dark:border-[rgba(255,255,255,0.05)]"
          >
            {/* Icon */}
